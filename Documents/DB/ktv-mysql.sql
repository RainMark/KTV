...
create table Similarity_Form(
SongID1 Varchar(20),
SongID2 Varchar(20),
Similarity float,
primary key(SongID1,SongID2),
foreign key(SongID1) references Song(SongID),
foreign key(SongID2) references Song(SongID)
);
...
insert into Song_List values('1','1');
insert into Song_List values('2','2');
insert into Song_List values('3','3');
insert into Song_List values('4','1');
insert into Song_List values('5','2');
insert into Song_List values('6','3');
insert into Song_List values('7','1');
insert into Song_List values('8','2');
insert into Song_List values('9','3');
insert into Song_List values('10','1');
insert into Song_List values('11','2');
insert into Song_List values('12','3');
insert into Song_List values('13','1');
insert into Song_List values('14','2');
insert into Song_List values('15','3');
insert into Song_List values('16','1');
insert into Song_List values('17','2');
insert into Song_List values('18','3');



insert into Similarity_Form values('1','2','0.1');
insert into Similarity_Form values('3','4','0.2');
insert into Similarity_Form values('5','6','0.15');
insert into Similarity_Form values('7','8','0.19');
insert into Similarity_Form values('9','10','0.23');
insert into Similarity_Form values('11','12','0.3');
insert into Similarity_Form values('18','21','0.43');
insert into Similarity_Form values('19','22','0.23');
insert into Similarity_Form values('31','32','0.34');
insert into Similarity_Form values('41','42','0.41');
insert into Similarity_Form values('47','48','0.43');